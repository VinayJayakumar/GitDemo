...
public class RowsAndColumns extends AbstractChromeWebDriver {
  ...
  public void Extracttablesize() {
	  ...
	  findElement.click();
	  List<WebElement> BrowserColMaster = Webdriver.findElements(By.xpath("//*[@id=\'dataTables-example\']/thead/tr/th"));
	  System.out.println("No of cloumns in the table are " + BrowserColMaster.size());
	  List<WebElement> BrowserRowMaster = Webdriver.findElements(By.xpath("//*[@id=\'dataTables-example\']/tbody/tr/td[1]"));
